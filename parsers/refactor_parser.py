...
class RefactorParser( ModuleParser ):
    ...
    def __init__(self, parser):
      ...
      refactor.add_argument('--rmcovar', action = "store_true", help = "specify if you want to remove covariates from data") # if epistructure is called with --rmcovar flag, the covariates are  removed from the data. (by default (without the flag) they are not removed). Note that this flag is appears also in epistructure
